    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-14 lg:px-20 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-10 md:mb-15">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#0693FB]/10 text-[#0693FB] text-[13px] font-semibold mb-6">
            Why IntelliERP
          </div>
          ...
          <p className="text-primary-light text-base max-w-md mx-auto">
