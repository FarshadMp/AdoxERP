...
import { Zap, BarChart3, Workflow, ArrowRight } from "lucide-react";
  ...
  return (
    <section className="relative py-14 md:py-22 bg-gray-50 overflow-hidden">
      <div className="max-w-4xl mx-auto px-6 md:px-14 lg:px-20 relative z-10 text-center">
        ...
        <h2 className="text-3xl md:text-5xl font-bold text-primary-dark leading-tight tracking-tighter mb-6">
        ...
        <p className="text-primary-light text-base leading-relaxed mb-12 max-w-md mx-auto">
