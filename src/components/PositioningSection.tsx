    ...
    >
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
        <div className="flex flex-col items-center">
          ...
          <div
            data-aos="fade-up"
            className="mb-6 px-4 py-1.5 rounded-full bg-[#0693FB]/10 text-[#0693FB] text-[12.5px] font-semibold flex items-center gap-2 border border-[#0693FB]/20"
          >
          ...
          <h2
            data-aos="fade-up"
            data-aos-delay="100"
            className="text-3xl md:text-4xl lg:text-[2.8rem] font-bold text-primary-dark leading-tight tracking-tight mb-6"
          >
            A New Category of{" "}
